...
export const story = () => ({
  ...
  template: `
    <div style="background: linear-gradient(106.15deg, #3C3C4E 0%, #00000D 100%); padding: 0; height: 600px; width: 100%; display:flex">
      ...
      transition: width 0.3s ease;">
        <div class="content__head" style=""></div>
        <div class="content__place" style=""></div>
      </div>
  </div>`,
});
